...
# Since latitude or longitude will only vary between [-180, -180] we will get the lowest precision somewhere between (1/8, 1/4) or (0.125, 0.25).
...
Because of the above-stated reasons, I conclude that this optimization may not be a good idea for my case, but, in the interest of research and experimentation here is [full set of changes](https://github.com/abhishekBansal/nexrad-render/pull/8/files).
